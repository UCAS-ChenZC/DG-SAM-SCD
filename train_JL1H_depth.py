from datasets.change_detection_depth import ChangeDetection_JL1H
...
class Options:
    def __init__(self):
        ...
        parser.add_argument("--data_name", type=str, default=r"JL1H")
        parser.add_argument("--Net_name", type=str, default="DT-SCD_Newkd_depDiff")
        parser.add_argument("--backbone", type=str, default="resnet34")
        parser.add_argument("--data_root", type=str, default="/home/solid/CD/datasets/SCD_data/JL1H/JL1_CdSc")
...
class Trainer:
    ...
    ###     VSCode tensor print setting     ###
        ...
        trainset = ChangeDetection_JL1H(root=args.data_root, mode="train")
        valset = ChangeDetection_JL1H(root=args.data_root, mode="val")
        testset = ChangeDetection_JL1H(root=args.data_root, mode="test")
    ...
    def validation(self, epoch):
        ...
        self.model.eval()
        metric = IOUandSek(num_classes=len(ChangeDetection_JL1H.CLASSES))
