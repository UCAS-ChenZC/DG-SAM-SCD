from datasets.change_detection_depth import ChangeDetection_Landsat_SCD
...
class Options:
    def __init__(self):
        ...
        parser.add_argument("--data_root", type=str, default="/home/solid/CD/datasets/SCD_data/Landsat-SCD")
